...
//        static List<ShiftPoint> ConvertSolution (IPickings clientWish, int[,] Yij, BottomOrTopOrDirect[,] bottomOrTopOrDirectMatrix)
//        {
...
//                var nextWish = clientWish.PickingList.Find(w => w.WishIdx == nextLocation);
